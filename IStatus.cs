...
namespace Optimus.LibOrquestrator
{
    ...
    public partial interface IStatus
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<HostAvailabilityDto>> VerifyHostAvailibilityWithHttpMessagesAsync(string url = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
