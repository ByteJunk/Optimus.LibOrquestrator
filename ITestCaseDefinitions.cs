...
namespace Optimus.LibOrquestrator
{
    ...
    /// </summary>
    public partial interface ITestCaseDefinitions
    {
        /// <summary>
        ...
        ///
        /// Responses:
        /// 200 Returns a list of Test Case Definitions filtered with
        /// queryOptions
        /// 403 If the caller doesn't have permissions to view Test Case
        /// Definitions
        /// </remarks>
        /// <param name='expand'>
        ...
        /// </exception>
        Task<HttpOperationResponse<ODataValueOfIEnumerableOfTestCaseDefinitionDto>> GetWithHttpMessagesAsync(string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
