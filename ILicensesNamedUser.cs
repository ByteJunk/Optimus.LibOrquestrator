...
namespace Optimus.LibOrquestrator
{
    ...
    public partial interface ILicensesNamedUser
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<ODataValueOfIEnumerableOfLicenseNamedUserDto>> GetLicensesNamedUserByRobottypeWithHttpMessagesAsync(RobotType robotType, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
