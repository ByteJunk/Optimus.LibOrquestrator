...
namespace Optimus.LibOrquestrator
{
    ...
    public static partial class RobotsExtensions
    {
            ...
            /// Folder/OrganizationUnit Id
            /// </param>
            public static ODataValueOfIEnumerableOfRobotDto GetRobotsFromFolderByFolderid(this IRobots operations, long folderId, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), long? xUIPATHOrganizationUnitId = default(long?))
            {
                return operations.GetRobotsFromFolderByFolderidAsync(folderId, expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ODataValueOfIEnumerableOfRobotDto> GetRobotsFromFolderByFolderidAsync(this IRobots operations, long folderId, string expand = default(string), string filter = default(string), string select = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), long? xUIPATHOrganizationUnitId = default(long?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetRobotsFromFolderByFolderidWithHttpMessagesAsync(folderId, expand, filter, select, orderby, top, skip, count, xUIPATHOrganizationUnitId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
