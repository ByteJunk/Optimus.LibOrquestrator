...
namespace Optimus.LibOrquestrator.Models
{
    ...
    /// </summary>
    public partial class JobStartedEventDto
    {
        /// <summary>
        /// Initializes a new instance of the JobStartedEventDto class.
        /// </summary>
        public JobStartedEventDto()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the JobStartedEventDto class.
        /// </summary>
        public JobStartedEventDto(string type, string eventId, System.DateTime timestamp, WebhookSimpleJobDto job = default(WebhookSimpleJobDto), int? tenantId = default(int?), long? organizationUnitId = default(long?), long? userId = default(long?))
        {
            Type = type;
            EventId = eventId;
            Timestamp = timestamp;
