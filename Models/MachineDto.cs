...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class MachineDto
    {
        ...
        /// <summary>
        /// Gets or sets robots assigned to template machine.
        /// </summary>
        [JsonProperty(PropertyName = "RobotUsers")]
        public IList<RobotUserDto> RobotUsers { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            if (RobotUsers != null)
            {
                foreach (var element in RobotUsers)
                {
                    if (element != null)
                    {
                        element.Validate();
