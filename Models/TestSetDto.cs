...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class TestSetDto
    {
        ...
        public IList<TestSetInputArgumentDto> InputArguments { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element2 in InputArguments)
                {
                    if (element2 != null)
                    {
                        element2.Validate();
