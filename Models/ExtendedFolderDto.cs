...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class ExtendedFolderDto
    {
        ...
        public ExtendedFolderDto(string displayName, bool? isSelectable = default(bool?), bool? hasChildren = default(bool?), int? level = default(int?), System.Guid? key = default(System.Guid?), string fullyQualifiedName = default(string), string description = default(string), bool? isPersonal = default(bool?), FolderDtoProvisionType? provisionType = default(FolderDtoProvisionType?), FolderDtoPermissionModel? permissionModel = default(FolderDtoPermissionModel?), long? parentId = default(long?), System.Guid? parentKey = default(System.Guid?), FolderDtoFeedType? feedType = default(FolderDtoFeedType?), long? id = default(long?))
        {
