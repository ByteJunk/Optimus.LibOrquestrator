...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class DomainUserAssignmentDto
    {
        ...
        public DomainUserAssignmentDto(string domain = default(string), string userName = default(string), string directoryIdentifier = default(string), DomainUserAssignmentDtoUserType? userType = default(DomainUserAssignmentDtoUserType?), IList<FolderRolesDto> rolesPerFolder = default(IList<FolderRolesDto>))
        {
            Domain = domain;
            UserName = userName;
