...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class LicenseDto
    {
        ...
        /// <param name="isCommunity">True if the current tenant is registered
        /// with a community license.</param>
        ...
        /// <param name="userLicensingEnabled">Whether user licensing is
        /// enabled or not.</param>
        public LicenseDto(long? hostLicenseId = default(long?), long? id = default(long?), long? expireDate = default(long?), long? gracePeriodEndDate = default(long?), long? gracePeriod = default(long?), string versionControl = default(string), IDictionary<string, long?> allowed = default(IDictionary<string, long?>), IDictionary<string, long?> used = default(IDictionary<string, long?>), bool? attendedConcurrent = default(bool?), bool? developmentConcurrent = default(bool?), bool? studioXConcurrent = default(bool?), bool? studioProConcurrent = default(bool?), IList<string> licensedFeatures = default(IList<string>), bool? isRegistered = default(bool?), bool? isCommunity = default(bool?), bool? isExpired = default(bool?), System.DateTime? creationTime = default(System.DateTime?), string code = default(string), bool? userLicensingEnabled = default(bool?))
        {
            ...
            Code = code;
            UserLicensingEnabled = userLicensingEnabled;
            CustomInit();
        }
        ...
        /// community license.
        /// </summary>
        [JsonProperty(PropertyName = "IsCommunity")]
        ...
        /// <summary>
        /// Gets or sets whether user licensing is enabled or not.
        /// </summary>
        [JsonProperty(PropertyName = "UserLicensingEnabled")]
