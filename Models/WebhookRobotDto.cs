...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class WebhookRobotDto
    {
        ...
        /// 'Floating'</param>
        public WebhookRobotDto(long? id = default(long?), string name = default(string), long? machineId = default(long?), string machineName = default(string), string description = default(string), string userName = default(string), WebhookRobotDtoType? type = default(WebhookRobotDtoType?), WebhookRobotDtoHostingType? hostingType = default(WebhookRobotDtoHostingType?), IList<WebhookEnvironmentDto> environments = default(IList<WebhookEnvironmentDto>), IDictionary<string, object> executionSettings = default(IDictionary<string, object>))
        {
            Id = id;
            Name = name;
            MachineId = machineId;
