...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class WebhookTaskAssignmentChangedDto
    {
        ...
        public WebhookTaskAssignmentChangedDto(string title = default(string), BaseWebhookTaskDtoType? type = default(BaseWebhookTaskDtoType?), BaseWebhookTaskDtoPriority? priority = default(BaseWebhookTaskDtoPriority?), BaseWebhookTaskDtoStatus? status = default(BaseWebhookTaskDtoStatus?), System.DateTime? creationTime = default(System.DateTime?), string taskCatalogName = default(string), long? id = default(long?), long? organizationUnitId = default(long?), long? assignedToUserId = default(long?), long? assignedToUserIdOldValue = default(long?))
        {
            Title = title;
            Type = type;
            Priority = priority;
