...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public enum AuditLogDtoComponent
    {
        ...
        PersonalWorkspaces,
        [EnumMember(Value = "CloudSubscriptions")]
        CloudSubscriptions,
        [EnumMember(Value = "TestSets")]
        TestSets
    }
    internal static class AuditLogDtoComponentEnumExtension
    {
        ...
        internal static string ToSerializedValue(this AuditLogDtoComponent value)
        {
            switch( value )
            {
                ...
                case AuditLogDtoComponent.TenantMove:
                    return "TenantMove";
                case AuditLogDtoComponent.Secrets:
                    return "Secrets";
                case AuditLogDtoComponent.PersonalWorkspaces:
                    return "PersonalWorkspaces";
                case AuditLogDtoComponent.CloudSubscriptions:
                    return "CloudSubscriptions";
                case AuditLogDtoComponent.TestSets:
                    return "TestSets";
            }
            return null;
        }
        ...
        internal static AuditLogDtoComponent? ParseAuditLogDtoComponent(this string value)
        {
            switch( value )
            {
                ...
                case "Secrets":
                    return AuditLogDtoComponent.Secrets;
                case "PersonalWorkspaces":
                    return AuditLogDtoComponent.PersonalWorkspaces;
                case "CloudSubscriptions":
                    return AuditLogDtoComponent.CloudSubscriptions;
                case "TestSets":
                    return AuditLogDtoComponent.TestSets;
            }
            return null;
        }
    }
