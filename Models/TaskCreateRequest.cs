...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class TaskCreateRequest
    {
        ...
        /// 'ExternalTask'. Possible values include: 'FormTask',
        ...
        /// <param name="externalTag">Reference or name of external
        /// system</param>
        public TaskCreateRequest(string title, TaskCreateRequestType? type = default(TaskCreateRequestType?), BaseTaskCreateRequestPriority? priority = default(BaseTaskCreateRequestPriority?), object data = default(object), string taskCatalogName = default(string), string externalTag = default(string))
        {
            Type = type;
            Title = title;
            Priority = priority;
        ...
        /// Possible values include: 'FormTask', 'ExternalTask',
        ...
        /// <summary>
        /// Gets or sets reference or name of external system
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            if (ExternalTag != null)
            {
                if (ExternalTag.Length > 128)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "ExternalTag", 128);
                }
            }
        }
    }
