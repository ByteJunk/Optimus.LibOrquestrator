...
namespace Optimus.LibOrquestrator.Models
{
    ...
    /// </summary>
    public partial class QueueItemStartedEventDto
    {
        /// <summary>
        /// Initializes a new instance of the QueueItemStartedEventDto class.
        /// </summary>
        public QueueItemStartedEventDto()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the QueueItemStartedEventDto class.
        /// </summary>
        public QueueItemStartedEventDto(string type, string eventId, System.DateTime timestamp, WebhookQueueItemDto queueItem = default(WebhookQueueItemDto), WebhookQueueDefinitionDto queue = default(WebhookQueueDefinitionDto), int? tenantId = default(int?), long? organizationUnitId = default(long?), long? userId = default(long?))
        {
            Type = type;
            EventId = eventId;
            Timestamp = timestamp;
