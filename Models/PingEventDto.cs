...
namespace Optimus.LibOrquestrator.Models
{
    ...
    public partial class PingEventDto
    {
        /// <summary>
        /// Initializes a new instance of the PingEventDto class.
        /// </summary>
        public PingEventDto()
        {
            CustomInit();
        ...
        /// Initializes a new instance of the PingEventDto class.
        /// </summary>
        public PingEventDto(string type, string eventId, System.DateTime timestamp, int? tenantId = default(int?), long? organizationUnitId = default(long?), long? userId = default(long?))
        {
            Type = type;
            EventId = eventId;
            Timestamp = timestamp;
