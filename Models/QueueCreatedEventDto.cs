...
namespace Optimus.LibOrquestrator.Models
{
    ...
    /// </summary>
    public partial class QueueCreatedEventDto
    {
        /// <summary>
        /// Initializes a new instance of the QueueCreatedEventDto class.
        /// </summary>
        public QueueCreatedEventDto()
        {
            CustomInit();
        }
        ...
        public QueueCreatedEventDto(string type, string eventId, System.DateTime timestamp, IList<WebhookQueueDefinitionDto> queues = default(IList<WebhookQueueDefinitionDto>), int? tenantId = default(int?), long? organizationUnitId = default(long?), long? userId = default(long?))
        {
            Type = type;
            EventId = eventId;
            Timestamp = timestamp;
